...
class RoadsceneConfig(Config): # bai
    ...
    NUM_CLASSES = 1 + 6  # Background + pothole + car + midlane + rightlane + dashedline + trafficsign
...
class RoadsceneDataset(utils.Dataset): # bai

    def load_roadscene(self, dataset_dir, subset): # bai
        """Load a subset of the Roadscene dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes.
        self.add_class("roadscene", 1, "pothole") # bai
        self.add_class("roadscene", 2, "car") # bai
        self.add_class("roadscene", 3, "midlane") # bai
        self.add_class("roadscene", 4, "rightlane") # bai
        self.add_class("roadscene", 5, "dashedline") # bai
        self.add_class("roadscene", 6, "trafficsign") # bai
        ...
        for a in annotations:
            ...
            class_ids = [int(n['roadscene']) for n in objects] # bai
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "roadscene":
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = RoadsceneDataset() # bai
    dataset_train.load_roadscene(args.dataset, "train") # bai
    dataset_train.prepare()

    # Validation dataset
    dataset_val = RoadsceneDataset() # bai
    dataset_val.load_roadscene(args.dataset, "val") # bai
    dataset_val.prepare()
...
def detect_and_show(model, image_path=None, video_path=None): #bai
    ...
    if image_path:
        # Validation dataset
        dataset = RoadsceneDataset()  # bai
        dataset.load_roadscene(args.dataset, "val")  # bai
        ...
        filter_classs_names = ['pothole', 'car', 'midlane', 'rightlane', 'dashedline', 'trafficsign']
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect roadscene.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/balloon/dataset/",
                        help='Directory of the Roadscene dataset')
    ...
    # Configurations
    if args.command == "train":
        config = RoadsceneConfig() # bai
    else:
        class InferenceConfig(RoadsceneConfig): # bai
